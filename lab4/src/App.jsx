                    ...
                    <Card className="block-form" title="Форма" bordered style={{ marginTop: 16 }} id="form">
                        ...
                        >
                            ...
                            <Form.Item label="Пол" name="gender">
                                <Radio.Group>                                    <Radio value="male">Мужской</Radio>
                                    <Radio value="female">Женский</Radio>
                                    <Radio value="other">Другое</Radio>
                                </Radio.Group>                            </Form.Item>                            <Form.Item label="Любимый язык" name="languages">
                            <Select mode="multiple" placeholder="Выберите языки">
                                {languages.map(l => <Select.Option key={l} value={l}>{l}</Select.Option>)}
                            </Select>
                        </Form.Item>                            <Form.Item label="Биография" name="bio"><Input.TextArea rows={4} placeholder="Биография" /></Form.Item>
                            ...
                            </Form.Item>                            <Form.Item wrapperCol={{ sm: { offset: 8, span: 16 }, xs: { span: 24 } }}>
                            <Button type="primary" htmlType="submit">Сохранить</Button>
                        </Form.Item>                        </Form>                    </Card>                </div>            </Content>
            {/* === ПОДВАЛ === */}
